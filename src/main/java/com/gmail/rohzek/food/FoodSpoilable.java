...
public class FoodSpoilable extends ItemFood
{
	...
	public FoodSpoilable(int hunger, float saturation, boolean isWolfFood, int time, boolean cooked, String name)
	{
	...
	public FoodSpoilable(int hunger, float saturation, boolean isWolfFood, int time, boolean cooked, String name, PotionEffect... effects)
	{
		super(hunger, saturation, isWolfFood);
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player) 
	{
		...
		if(!worldIn.isRemote)
		{
			...
			if(condition == 0)
			{
				...
				{
					player.addPotionEffect(new PotionEffect(MobEffects.HUNGER, 300, 10, true, true));
					player.addPotionEffect(new PotionEffect(MobEffects.POISON, 900, 10, true, true));
				}
			}
